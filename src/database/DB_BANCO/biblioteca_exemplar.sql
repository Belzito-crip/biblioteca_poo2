...
CREATE TABLE `exemplar` (
  ...
  CONSTRAINT `FK_Exemplar_Livro` FOREIGN KEY (`idlivro`) REFERENCES `livro` (`idlivro`)
...
INSERT INTO `exemplar` VALUES (1,1,1001,'disponivel'),(2,1,1001,'1'),(3,1,1001,'0'),(4,2,1002,'disponivel');
...
-- Dump completed on 2025-11-26 20:43:18
